...
//! distance and a boolean. The question *what a reference should be built out of* -- the
//! three-policy simulation scored through the shipped identifier -- lives in
//! [`crate::reference_policies`], which scores its distance populations with this module's
//! arithmetic rather than re-implementing it.
//!
