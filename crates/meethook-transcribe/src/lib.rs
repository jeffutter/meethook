...
pub use merge::merge;
pub use models::{EMBEDDING_MODEL, SEGMENTATION_MODEL, SILERO_VAD_MODEL, WHISPER_MODEL};
...
pub fn transcribe_session(
    ...
    let mic_track = clean_mic_track(
        session,
        &speaker_track,
        crate::timeline::mic_minus_speaker_seconds(&metadata)?,
        progress,
    )?;
...
mod tests {
    ...
    use crate::timeline::mic_minus_speaker_seconds;
